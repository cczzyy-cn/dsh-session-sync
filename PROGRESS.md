...
| 版本 | **`0.4.6`**（tag `v0.4.6` → `fff15a0`）· 本地 = 远端 |
| 服务器 | `210.16.120.228` · Ubuntu 24.04 · **DSH `0.1.7-rc.2`（npm `next` 通道，未打补丁）** · 插件 **`v0.4.5`**（依赖钉 tag，lock → `823a37e`；本机与服务器均为 0.4.6 前待升级）· unit `dsh-web.service` · active |
